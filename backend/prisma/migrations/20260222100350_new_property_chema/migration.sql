...
INSERT INTO "new_Property" ("address", "archivedAt", "area", "balcony", "bargaining", "bathroom", "condition", "createdAt", "encumbrance", "floor", "fullDescription", "hasElevator", "housingTypeId", "id", "kitchenArea", "latitude", "livingArea", "longitude", "mortgagePossible", "operationId", "ownership", "parking", "price", "propertyTypeId", "readyToMove", "renovation", "renovationYear", "shortDescription", "slug", "status", "totalArea", "totalFloors", "updatedAt", "view", "windows", "yearBuilt") SELECT "address", "archivedAt", "area", "balcony", "bargaining", "bathroom", "condition", "createdAt", "encumbrance", "floor", "fullDescription", "hasElevator", "housingTypeId", "id", "kitchenArea", "latitude", "livingArea", "longitude", "mortgagePossible", "operationId", "ownership", "parking", "price", "propertyTypeId", "readyToMove", "renovation", "renovationYear", "shortDescription", "slug", "status", "totalArea", "totalFloors", "updatedAt", "view", "windows", "yearBuilt" FROM "Property";
DROP TABLE "Property";
